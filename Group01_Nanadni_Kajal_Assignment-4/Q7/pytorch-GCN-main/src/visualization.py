...
def visualize_embedding_tSNE(labels, out_features, num_classes):
    ...
    plt.savefig('/content/drive/MyDrive/CSIR_GL/pytorch-GCN-main/imgs/tSNE.png')
    plt.show()
...
def visualize_graph(edges, node_labels, save=False):
    ...
    if save:
        out.save("/content/drive/MyDrive/CSIR_GL/pytorch-GCN-main/imgs/cora_visualized.png")
...
def visualize_validation_performance(val_acc, val_loss):
    ...
    plt.savefig('/content/drive/MyDrive/CSIR_GL/pytorch-GCN-main/imgs/Val_Loss_Acc.png')
    plt.show()
