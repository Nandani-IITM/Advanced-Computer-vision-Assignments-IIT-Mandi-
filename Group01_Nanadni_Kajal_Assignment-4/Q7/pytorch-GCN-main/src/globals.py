...
parser.add_argument("--nodes_path", type=str, default="/content/drive/MyDrive/CSIR_GL/pytorch-GCN-main/data/cora.content")
parser.add_argument("--edges_path", type=str, default="/content/drive/MyDrive/CSIR_GL/pytorch-GCN-main/data/cora.cites")
